...
export interface Spec extends TurboModule {
    searchESPDevices(devicePrefix: string, transport: string, security: number): Promise<ESPDeviceInterface[]>;
    stopESPDevicesSearch(): void;
    createESPDevice(deviceName: string, transport: string, security: number, proofOfPossession?: string, softAPPassword?: string, username?: string): Promise<ESPDeviceInterface>;
    ...
    setProofOfPossession(deviceName: string, proofOfPossession: string): Promise<string | undefined>;
    getUsername(deviceName: string): Promise<string | undefined>;
    setUsername(deviceName: string, username: string): Promise<string | undefined>;
    getDeviceName(deviceName: string): Promise<string | undefined>;
    setDeviceName(deviceName: string, newDeviceName: string): Promise<string | undefined>;
    getPrimaryServiceUuid(deviceName: string): Promise<string | undefined>;
    setPrimaryServiceUuid(deviceName: string, primaryServiceUuid: string): Promise<string | undefined>;
    getSecurityType(deviceName: string): Promise<number | undefined>;
    setSecurityType(deviceName: string, securityType: number): Promise<number | undefined>;
    getTransportType(deviceName: string): Promise<string | undefined>;
    getVersionInfo(deviceName: string): Promise<{
        [key: string]: any;
    }[] | undefined>;
...
//# sourceMappingURL=NativeEspIdfProvisioning.d.ts.map